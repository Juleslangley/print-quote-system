      ...
      >
        ...
        >
          ...
          <div style={{ border: "1px solid #e5e5e7", borderRadius: 12, padding: 14, background: "#fafafa" }}>
            <div className="subtle" style={{ fontSize: 12, fontWeight: 600, marginBottom: 10 }}>Basic</div>
            <div className="row">
              <div className="col">
          ...
          {/* Supplier & defaults */}
          <div style={{ border: "1px solid #e5e5e7", borderRadius: 12, padding: 14, background: "#fafafa" }}>
            <div className="subtle" style={{ fontSize: 12, fontWeight: 600, marginBottom: 10 }}>Supplier & defaults</div>
            <div className="row">
              <div className="col">
          ...
          {matType === "roll" && (
            <div style={{ border: "1px solid #e5e5e7", borderRadius: 12, padding: 14, background: "#fafafa" }}>
              <div className="subtle" style={{ fontSize: 12, fontWeight: 600, marginBottom: 10 }}>Roll</div>
              <div className="row">
                <div className="col">
          ...
          {/* Meta (optional) */}
          <div style={{ border: "1px solid #e5e5e7", borderRadius: 12, padding: 14, background: "#fafafa" }}>
            <div className="subtle" style={{ fontSize: 12, fontWeight: 600, marginBottom: 8 }}>Meta (optional)</div>
            {!editAdvancedMeta ? (
          ...
          {editing ? (
            <div style={{ border: "1px solid #e5e5e7", borderRadius: 12, padding: 14, background: "#fafafa" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                <span className="subtle" style={{ fontSize: 12, fontWeight: 600 }}>Sizes</span>
                      ...
                      <tbody>
                        {sizes.map((s) => (
                          <tr key={s.id} style={{ borderBottom: "1px solid #eee" }}>
                            ...
                            <td style={{ padding: "4px 6px" }}>
                              <button type="button" onClick={() => openEditSize(s)}>Edit</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
            ...
            <div style={{ border: "1px solid #e5e5e7", borderRadius: 12, padding: 14, background: "#fafafa" }}>
              <div className="subtle" style={{ fontSize: 12, fontWeight: 600, marginBottom: 6 }}>Sizes</div>
          ...
          {editing && (
            <div style={{ border: "1px solid #eee", borderRadius: 12, padding: 12, background: "#fafafa" }}>
              <div className="subtle" style={{ fontSize: 12, marginBottom: 6 }}>Usage</div>
              {usage != null ? (
