"""Add document_templates table for admin PDF templates.

Revision ID: 016_document_templates
Revises: 015_mat_size_custom_len
Create Date: 2026-02-16

Stores admin-managed template PDFs for generated documents (PO/invoice/quote/credit note/production order).
"""
...
revision: str = "016_document_templates"
down_revision: Union[str, None] = "015_mat_size_custom_len"
