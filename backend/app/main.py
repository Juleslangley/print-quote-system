...
from app.api import margin_profiles, pricing_rules, suppliers, purchase_orders, purchase_order_lines, backup, health, jobs, packing, po_template
...
app.include_router(po_template.router, prefix="/api", tags=["po-template"])
